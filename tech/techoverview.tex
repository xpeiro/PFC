...
\subsubsection{V-REP: Virtual Khepera III}
\begin{figure}[H]
\centering
...
\begin{itemize}
  ...
  would break hard real-time requirements much sooner than using an interpreted language, so the point would be likely moot.
\end{itemize}
